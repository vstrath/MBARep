...
RUN export JAVA_HOME=/usr/lib/jvm/default-java && su hduser -c /usr/local/hadoop/bin/hadoop namenode -format
RUN export JAVA_HOME=/usr/lib/jvm/default-java && su hduser -c /usr/local/hadoop/sbin/start-all.sh

#Starting Hadoop
CMD export JAVA_HOME=/usr/lib/jvm/default-java && su hduser /usr/local/hadoop/bin/hadoop namenode -format
CMD export JAVA_HOME=/usr/lib/jvm/default-java && su hduser /usr/local/hadoop/sbin/start-all.sh
